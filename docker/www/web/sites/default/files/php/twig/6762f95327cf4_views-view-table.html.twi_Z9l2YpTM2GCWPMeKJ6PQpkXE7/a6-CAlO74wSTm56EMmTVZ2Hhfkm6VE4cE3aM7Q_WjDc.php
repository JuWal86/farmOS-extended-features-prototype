...
class __TwigTemplate_ce7b8e07b2f5b3a5b225dea4767c27f6 extends Template
{
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 61)) {
                    ...
                    yield "              ";
                    // line 63
                    $context["column_classes"] = ["views-field", ("views-field-" . $this->sandbox->ensureToStringAllowed((($_v0 =                     // line 65
($context["fields"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[$context["key"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["fields"] ?? null), $context["key"], [], "array", false, false, true, 65)), 65, $this->source))];
                    // line 68
                    yield "            ";
                }
                // line 69
